...
extern uint8_t  uart_rcvbuf1[];
extern uint8_t  uart_rcvbuf2[];

extern uint8_t volatile bUartDataReady1;
extern uint8_t volatile bufhead1;

extern uint8_t volatile bUartDataReady2;
extern uint8_t volatile bufhead2;
/*-------------------------------------------------------------*/
